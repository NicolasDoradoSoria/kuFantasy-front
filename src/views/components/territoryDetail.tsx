    ...
    <AnimatePresence>
      {territory && (
        <motion.div
          ...
          shadow-xl px-8 py-6 min-w-[320px] max-w-[400px] text-left ${
            !isModal ? "mt-2 mb-10" : ""
          }`}
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <span className="text-2xl">
              {TypeIcons[territory.type as keyof typeof TypeIcons] || "❓"}
            </span>
            ...
            <span
              className={`ml-auto px-2 py-1 rounded ${
                DifficultyColors[
                  territory.difficulty as keyof typeof DifficultyColors
          ...
          <p className="italic text-gray-700 mb-2">
            {territory.info.shortDescription}
          </p>
          <p className="text-gray-600 text-sm mb-2">
            {territory.info.longDescription}
          </p>
          ...
          <div className="mb-2">
            ...
            <div className="flex flex-wrap gap-2 mt-1">
              {territory.resources.map((r) => (
                <span
                  key={r.id}
                  className="px-2 py-1 rounded bg-blue-100 text-blue-800 text-xs font-semibold border border-blue-300"
                >
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-1">
              {territory.enemies.map((e) => (
                <span
                  key={e.id}
                  className="px-2 py-1 rounded bg-red-100 text-red-800 text-xs font-semibold border border-red-300"
                >
